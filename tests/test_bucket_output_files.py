...
class BucketOutputFilesTest(unittest.TestCase):
    ...
    def test_bucket_reporting_outputs_requested_columns(self) -> None:
        ...
        self.assertNotIn("HBM+单机 1T Strict-Prefix 同负载估算卡数", summary_csv)
        self.assertNotIn("HBM+单机 1T Strict-Prefix 同负载估算机器数", summary_csv)
        ...
        self.assertNotIn("HBM+单机 1T Strict-Prefix 同负载估算卡数", planning_strict_prefix_csv)
        self.assertNotIn("HBM+单机 1T Strict-Prefix 同负载估算机器数", planning_strict_prefix_csv)
        ...
        self.assertNotIn("HBM+单机 1T LRU 同负载估算卡数", planning_lru_csv)
        self.assertNotIn("HBM+单机 1T LRU 同负载估算机器数", planning_lru_csv)
